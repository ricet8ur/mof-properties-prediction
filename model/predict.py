...
from model.cgcnn.data import CIFData
from model.cgcnn.data import collate_pool
...
if os.path.isfile(args.modelpath):
    ...
    print("=> loaded model '{}' (epoch {}, validation {}, args {})"
          .format(args.modelpath, checkpoint['epoch'],
                  checkpoint['best_mae_error'],checkpoint['args']))
else:
